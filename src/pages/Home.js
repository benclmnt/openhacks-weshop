      ...
      <div style={{ backgroundColor: 'rgba(238, 110, 115, 0.5)' }}>
        ...
        >
          <div style={{ flex: 2 }}>
            ...
            <Link
              to={REGISTER}
              className="btn btn-large white z-depth-2 black-text"
        ...
        <div className="ss-container" style={{ paddingTop: 40 }}>
          <div style={{ flex: 1, textAlign: 'center' }}>
            ...
            <div style={{ padding: 20, margin: 'auto' }}>
              Wide variety of groceries to choose from
            </div>
          </div>
          <div style={{ flex: 1, textAlign: 'center' }}>
            <img src={Heart} style={{ height: 150 }} />
            <div style={{ padding: 20, margin: 'auto' }}>
              Helps reduce crowds at grocery stores to combat the outbreak of
              Covid-19 and reduce the risks for the vulnerables
            </div>
          </div>
          <div style={{ flex: 1, textAlign: 'center' }}>
            <img src={Money} style={{ height: 150 }} />
            <div style={{ padding: 20, margin: 'auto' }}>
              More cost efficient with regards to delivery and sustainability
            </div>
          </div>
        </div>
      </div>
